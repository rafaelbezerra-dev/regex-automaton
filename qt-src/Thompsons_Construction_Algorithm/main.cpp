 ...
 * Code by kennyledet [https://github.com/kennyledet]
 * from https://github.com/kennyledet/Algorithm-Implementations/tree/master/Thompsons_Construction_Algorithm/C%2B%2B/AlexMathew
 * */
#include<iostream>
#include<vector>
#include<string>
